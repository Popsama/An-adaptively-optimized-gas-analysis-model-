...
if __name__ == "__main__":
    ...
    save_path1 = r"D:\PYHTON\python3.7\DeepLearningProgram\深度学习滤波器\1000组模拟数据\提供给模型的数据\模拟数据\CH_nonoise_spectral.npy"
    np.save(save_path1, CH4_no_noise)
    ...
    save_path2 = r"D:\PYHTON\python3.7\DeepLearningProgram\深度学习滤波器\1000组模拟数据\提供给模型的数据\模拟数据\CH_noisy_spectral.npy"
    np.save(save_path2, CH4_noisy)
